<?php
    ...
    $sql_query = "SELECT * FROM `member list` WHERE user_id='$id'";
...
<body>
    <div>
        <h1>
            <center>My Clubs & Societies</center><br>
        </h1>
    </div>
    <?php 
    ...
    <div class="card column" style="width: 18rem;">
        ...
        <div class="card-body justify-content-center">
            ...
            <a href="memberViewMyClubDetails.php?id=<?php echo $row['member_id']?>" class="btn btn-primary">Check Details</a>
        </div>
    </div>
