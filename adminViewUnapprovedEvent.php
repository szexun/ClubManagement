<?php
    ...
    $sql_query = "SELECT * FROM `event details` WHERE approval = 'No Approve'";
...
<body>
    <div>
        <h1>
            <center>UnApproved Events</center><br>
        </h1>
    </div>
    <?php 
    ...
    <div class="card column" style="width: 18rem;">
        ...
        <div class="card-body justify-content-center">
            ...
            <a href="adminApproveEvent.php?eventID=<?php echo $row['eventID']?>" class="btn btn-primary">Approve Event</a>
        </div>
    </div>
