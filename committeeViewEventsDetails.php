        ...
        <div class="row g-0">
            ...
            <div class="col-md-8">
                <div class="card-body">
                    ...
                    <p class="card-text"><small class="text-muted">Status: <?php echo $row['approval']?></small></p>
                    <br>
                    <a href="committeeViewParticipant.php?eventID=<?php echo $row['eventID']?>" class="btn btn-secondary">Participant List</a>
                    <br>
                    <br>
                    <a href="committeeEditEventDetails.php?eventID=<?php echo $row['eventID']?>" class="btn btn-primary">Edit
                        Event</a>
                    <a href="committeeDeleteEvent.php?eventID=<?php echo $row['eventID']?>" class="btn btn-danger">Delete
                        Event</a>
                </div>
            </div>
        </div>
