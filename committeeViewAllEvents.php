<?php
    ...
    $sql_query = "SELECT * FROM `event details`";
...
<body>
    ...
    <div class="card column" style="width: 18rem;">
        ...
        <div class="card-body justify-content-center">
            ...
            <a href="committeeViewEventsDetails.php?eventID=<?php echo $row['eventID']?>" class="btn btn-primary">More Details</a>
        </div>
    </div>
