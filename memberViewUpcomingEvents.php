<?php
    ...
    $sql_query = "SELECT * FROM `event details` WHERE event_date > NOW()";
...
<body>
    <div>
        <h1>
            <center>Upcoming Events</center><br>
        </h1>
    </div>
    <?php 
    ...
    <div class="card column" style="width: 18rem;">
        ...
        <div class="card-body justify-content-center">
            ...
            <a href="memberViewUpcomingEventDetails.php?eventID=<?php echo $row['eventID']?>" class="btn btn-primary">More Details</a>
        </div>
    </div>
